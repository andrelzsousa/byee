...
function Home() {
    ...
    return (
        <div className="grid grid-cols-6 p-10">
            <div className="flex gap-2 flex-wrap col-span-4">
                {data?.map((product) => {
                    return(
                        <div className="border border-black rounded-xl flex flex-col gap-1 items-center p-2 w-44 h-48 relative" key={product.id}>
